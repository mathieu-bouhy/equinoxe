...
export interface CashFlowReport { years:number[]; lines:CashFlowLine[]; accountDetails?:Record<string,ProfitLossAccount[]>; openingCash?:Record<string,number>; closingCash?:Record<string,number>; generatedAt:string; source:'odoo' }
