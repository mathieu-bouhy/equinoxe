...
export function CashEvolution({ companyId, editable }: { companyId: string; editable: boolean }) {
  ...
  const download = useMutation({ mutationFn: async () => {
    ...
    link.href = url; link.download = `gimi-tresorerie-2024-01-${query.data?.through.slice(0,7)}.csv`;
  ...
  return <div className="cash-evolution">
    <Card>
      <div className="cash-evolution-heading"><div><p className="eyebrow">Gimi · trésorerie et placements</p><h2>Évolution de la trésorerie</h2>
      ...
      {report && <>
        ...
        <div className="cash-evolution-summary">
    ...
    {report && <>
      <Card><h2>Détail mensuel</h2><p>Montants en milliers d’euros. Cliquez sur un mois pour consulter ses soldes journaliers.</p>
        <div className="report-table"><table className="report-matrix cash-month-table"><thead><tr><th>Mois</th><th>Jours</th><th>Moyenne</th><th>Minimum</th><th>Maximum</th><th>Clôture</th><th>Contrôle Odoo</th></tr></thead>
