...
const data: Record<string, CapexCategory[]> = {
  gimi: [
    ...
    { code: '23', label: 'Installations, machines et outillage', values: { 2023: empty(), 2024: empty(), 2025: row({ acquisitionInitial: 26701, acquisitionEnd: 26701, amortizationInitial: 24597, amortizationBooked: 2104, amortizationEnd: 26701, netBookValue: 0 }), 2026: empty() } },
    { code: '24', label: 'Mobilier et matériel roulant', values: { 2023: empty(), 2024: empty(), 2025: row({ acquisitionInitial: 659873, acquisitions: 310165, disposals: 142952, acquisitionEnd: 827086, amortizationInitial: 319878, amortizationBooked: 151777, amortizationCancelled: 114831, amortizationEnd: 356823, netBookValue: 470262 }), 2026: empty() } },
    { code: '26', label: 'Autres immobilisations corporelles', values: { 2023: empty(), 2024: empty(), 2025: row({ acquisitionInitial: 17952, acquisitionEnd: 17952, amortizationInitial: 5536, amortizationBooked: 1800, amortizationEnd: 7336, netBookValue: 10616 }), 2026: empty() } },
